...
import 'package:sa3_noite_correcao/View/CadastroView.dart';
import 'package:sa3_noite_correcao/View/TarefasView.dart';
      ...
      try {
        ...
        if (user != null) {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => TarefasPage(email: user.email),
            ),
          );
        } else {
