...
public class TecnicosPanel extends JPanel {
    ...
    public TecnicosPanel() {
        ...
        estilizarBotao(btnCadastrarTecnico, new Color(70, 130, 180)); // Azul
        estilizarBotao(btnSalvarAlteracoes, Color.GREEN); // Verde
        estilizarBotao(btnDeletarTecnico, Color.RED); // Vermelho
    ...
    private void estilizarBotao(JButton button, Color backgroundColor) {
